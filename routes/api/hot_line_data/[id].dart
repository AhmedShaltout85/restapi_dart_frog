...
import 'package:restapi_dart_frog/repositories/hot_line_data_repository.dart';
import 'package:restapi_dart_frog/utils/response_helper.dart';

final _repository = HotLineDataRepository();
...
Future<Response> _update(RequestContext context, int id) async {
  try {
    ...
    // Note: HotLineData doesn't have copyWith method, so we create a new instance
    final model = HotLineData.fromJson({...body, 'id': id});
