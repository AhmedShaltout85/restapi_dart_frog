...
import 'package:restapi_dart_frog/repositories/handasat_tools_repository.dart';
import 'package:restapi_dart_frog/utils/response_helper.dart';

final _repository = HandasatToolsRepository();
...
Future<Response> _update(RequestContext context, int id) async {
  try {
    ...
    await _repository.update(id, HandasatTools.fromJson(body).copyWith(id: id));
