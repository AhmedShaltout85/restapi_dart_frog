...
import 'package:restapi_dart_frog/repositories/hot_line_status_data_repository.dart';
import 'package:restapi_dart_frog/utils/response_helper.dart';

final _repository = HotLineStatusDataRepository();
...
Future<Response> _create(RequestContext context) async {
  try {
    ...
    final id = await _repository.create(HotLineStatusData.fromJson(body));
